...
defbindings("WScreen", {
    ...
    -- Modify volume leves and change playing songs.
    bdoc("Change volume level -3 down."),
    kpress(ALTMETA.."KP_Subtract", "ioncore.exec_on(_, 'aumix -v-3')"),

    bdoc("Change volume level +3 up."),
    kpress(ALTMETA.."KP_Add", "ioncore.exec_on(_, 'aumix -v+3')"),


    bdoc("Media Player Daemon, Rewind 5 secs.."),
    kpress(META.."KP_Subtract", "ioncore.exec_on(_, 'mpc seek -5')"),

    bdoc("Media Player Daemon, Forward 5 secs.."),
    kpress(META.."KP_Add", "ioncore.exec_on(_, 'mpc seek +5')"),

    --bdoc("Rhythmbox, Play-Pause."),
    --kpress(META.."KP_Divide", "ioncore.exec_on(_, 'rhythmbox-client --no-start --no-present --play-pause')"),
    bdoc("Media Player Daemon, Play-Pause."),
    kpress(META.."KP_Divide", "ioncore.exec_on(_, 'mpc toggle')"),

    --bdoc("Rhythmbox, Previous Song."),
    --kpress(ALTMETA.."KP_Divide", "ioncore.exec_on(_, 'rhythmbox-client --no-start --no-present --previous')"),
    bdoc("Media Player Daemon, Previous Song."),
    kpress(ALTMETA.."KP_Divide", "ioncore.exec_on(_, 'mpc prev')"),

    --bdoc("Rhythmbox, Next Song."),
    --kpress(ALTMETA.."KP_Multiply", "ioncore.exec_on(_, 'rhythmbox-client --no-start --no-present --next')"),
    bdoc("Media Player Daemon, Next Song."),
    kpress(ALTMETA.."KP_Multiply", "ioncore.exec_on(_, 'mpc next')"),
...
defbindings("WFrame", {
    ...
    bdoc("Hide Frame tabs."),
    kpress(META.."F1", "WFrame.set_mode(_, 'tiled-alt')"),
    bdoc("Show Frame tabs."),
    kpress(META.."F2", "WFrame.set_mode(_, 'tiled')"),
})
